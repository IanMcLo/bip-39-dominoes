...
- **Roll Requirements Per Tier:** Draw counts are chosen for a comfortable rejection-sampling safety margin (all tiers land between 1-in-200,000 and 1-in-1.4 million exact rejection probability):
